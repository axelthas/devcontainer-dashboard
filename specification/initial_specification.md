...
- **Processing Rules:**
  1. **Filter:** Exclude any containers that have _no_ exposed host ports.
...
_Fallback:_ Any unrecognized port should render generically as "Port \[Number\]" using a Server icon.
